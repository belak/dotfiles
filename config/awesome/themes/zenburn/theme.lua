...
-- {{{ Main
theme = {}
theme.wallpaper = awful.util.getdir("config") .. "/themes/zenburn/zenburn-background.png"
-- }}}
...
-- {{{ Titlebar
theme.titlebar_close_button_focus  = awful.util.getdir("config") .. "/themes/zenburn/titlebar/close_focus.png"
theme.titlebar_close_button_normal = awful.util.getdir("config") .. "/themes/zenburn/titlebar/close_normal.png"
...
theme.titlebar_maximized_button_focus_active  = awful.util.getdir("config") .. "/themes/zenburn/titlebar/maximized_focus_active.png"
theme.titlebar_maximized_button_normal_active = awful.util.getdir("config") .. "/themes/zenburn/titlebar/maximized_normal_active.png"
theme.titlebar_maximized_button_focus_inactive  = awful.util.getdir("config") .. "/themes/zenburn/titlebar/maximized_focus_inactive.png"
theme.titlebar_maximized_button_normal_inactive = awful.util.getdir("config") .. "/themes/zenburn/titlebar/maximized_normal_inactive.png"
-- }}}
-- }}}
