...
=guide-key= provides a nice interface for showing prefix commands. We
make it show up for all C-c commands.
...
*** TODO Figure out why show-trailing-whitespace doesn't work
