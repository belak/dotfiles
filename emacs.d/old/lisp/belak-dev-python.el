;;; belak-dev-python.el --- python related packages and settings
...
;; Elpy does *all* the things, so we used to use that. Unfortunately,
;; it proved to be relatively slow and buggy, so we've since moved on.
...
(provide 'belak-dev-python)

;;; belak-dev-python.el ends here
