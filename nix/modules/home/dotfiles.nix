...
in {
  options.belak.dotfiles = {
    ...
    dotfilesPath = lib.mkOption {default = "${config.belak.homeDirectory}/.dotfiles";};
  };
  ...
  config = lib.mkIf cfg.enable {
    home.file = {
      ...
      # errors.
      ".config/home-manager/flake.nix".source = config.lib.file.mkOutOfStoreSymlink "${cfg.dotfilesPath}/nix/flake.nix";
    };
  };
}
